...
const items: Item[] = [
  {
    ...
    desc: "30-страничный отчёт с активными ссылками на Росстат, ФНС, ЕГРЮЛ. Каждая цифра — проверяема построчно. Без «по экспертным оценкам».",
    badge: "Все тарифы",
  },
  {
    icon: Sheet,
  ...
  },
  {
    ...
    desc: "Динамика рынка, структура CAPEX и OPEX, точка безубыточности, NPV/IRR-кривые, sensitivity-анализ. В отчёте PNG, в Excel — динамические.",
    badge: "От 14 990 ₽",
  },
  {
    icon: MapIcon,
